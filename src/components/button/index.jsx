...
const filledStyles = 'text-white bg-black rounded-lg font-bold py-2 px-6 mx-0 h-min hover:bg-transparet hover:text-almost-black border-2 border-almost-black'
